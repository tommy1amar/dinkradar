...
const PADDLES = [
  {
    ...
    brand: "Vatic Pro",
    price: 90,
    image: "https://m.media-amazon.com/images/I/616ENodpk-L._AC_SL1500_.jpg",
    affiliateLink: "https://amzn.to/417IUoU",
    weight: "7.6-7.9 oz",
    ...
    control: 9,
    spin: 8,
    tags: ["control", "beginner", "intermediate", "medium", "mid-spin", "budget"],
    description: "Widely considered the #1 paddle under $100. Fast hands, solid control, great spin. Perfect for learning and improving.",
  },
  {
    id: 2,
    name: "Ronbus Quanta R3 16mm",
    brand: "Ronbus",
    price: 100,
    image: "https://m.media-amazon.com/images/I/61AN4dYNRnL._AC_SL1500_.jpg",
    affiliateLink: "https://amzn.to/4m0kSWs",
    weight: "7.8-8.1 oz",
    core: "Polymer Honeycomb",
    surface: "Raw Carbon Fiber T700",
    power: 8,
    control: 7,
    spin: 8,
    tags: ["power", "beginner", "intermediate", "medium", "mid-spin", "mid"],
    description: "Most powerful paddle at $100. Super quick and aggressive. Elongated shape adds reach for singles. Multiple shapes available.",
  },
  {
    id: 3,
    ...
    brand: "11SIX24",
    price: 100,
    image: "https://m.media-amazon.com/images/I/41HcbINlKhL._AC_.jpg",
    affiliateLink: "https://amzn.to/4dmFYfE",
    weight: "7.6-7.9 oz",
    core: "Polymer",
    surface: "Toray T700 Carbon + Fiberglass",
    power: 6,
    control: 9,
    spin: 8,
    tags: ["all-around", "beginner", "intermediate", "medium", "mid-spin", "mid"],
    description: "Foam-injected edges create a massive sweet spot. One of the best control and forgiveness paddles at any price. Perfect for doubles.",
  },
  {
    id: 4,
    name: "Selkirk SLK Evo Control Max 2.0",
    brand: "Selkirk",
    price: 100,
    image: "https://m.media-amazon.com/images/I/7190REkC-uL._AC_SL1500_.jpg",
    affiliateLink: "https://amzn.to/4m9gIvI",
    weight: "7.6-7.9 oz",
    core: "Polymer Rev-Core",
    surface: "G8-Flex Composite",
    power: 5,
    control: 8,
    spin: 7,
    tags: ["control", "beginner", "medium", "mid-spin", "mid"],
    description: "Selkirk is the most trusted name in rec pickleball. Consistent spin without needing wrist snap. Quieter core for noise-restricted courts.",
  },
  {
    id: 5,
    name: "Doctor Pickleball Surgical Control",
    brand: "Doctor Pickleball",
    price: 50,
    image: "https://m.media-amazon.com/images/I/61t0ZU8ga6L._AC_SL1500_.jpg",
    affiliateLink: "https://amzn.to/41EdQ07",
    weight: "7.8-8.1 oz",
    core: "Polymer",
    ...
    control: 10,
    spin: 7,
    tags: ["control", "beginner", "medium", "mid-spin", "budget"],
    description: "At under $50 this is unbeatable for beginners. 20mm thickness gives exceptional control and sweet spot. Best way to learn without spending.",
  },
  {
    id: 6,
    name: "JOOLA Agassi Edge",
    brand: "JOOLA",
    price: 70,
    image: "https://m.media-amazon.com/images/I/61PX8jMyNoL._AC_SL1500_.jpg",
    affiliateLink: "https://amzn.to/41r751X",
    weight: "7.6-7.9 oz",
    core: "Polymer",
    ...
    control: 8,
    spin: 7,
    tags: ["all-around", "beginner", "intermediate", "medium", "mid-spin", "budget"],
    description: "Top brand at a budget price. Buttery smooth feel that rivals expensive paddles. Great balanced performance for developing players.",
  },
  {
    id: 7,
    name: "HEAD Gravity",
    brand: "HEAD",
    price: 84,
    image: "https://m.media-amazon.com/images/I/61y9xWffWEL._AC_SL1100_.jpg",
    affiliateLink: "https://amzn.to/3O32zTW",
    weight: "8.1 oz",
    core: "Polypropylene",
    surface: "Graphite/Composite Hybrid",
    power: 7,
    control: 8,
    spin: 7,
    tags: ["all-around", "beginner", "intermediate", "heavy", "mid-spin", "budget"],
    description: "HEAD brings trusted racket sport engineering to pickleball. Massive sweet spot from the Sweetspot Power Core. 3D spin texture grabs the ball. Comfortable EVA grip with vibration dampening. Great transition paddle from beginner to intermediate.",
  },
  {
    id: 8,
    name: "CPX Pro Carbon Fiber Black Air",
    brand: "CPX",
    price: 70,
    image: "https://m.media-amazon.com/images/I/71ahXsw3ThL._AC_SL1500_.jpg",
    affiliateLink: "https://amzn.to/4vb7XFx",
    weight: "7.8 oz",
    core: "Polymer",
    surface: "Carbon Fiber",
    power: 5,
    control: 9,
    spin: 7,
    tags: ["control", "all-around", "beginner", "medium", "mid-spin", "budget"],
    description: "The 19mm core is the thickest in the CPX lineup — made for precision dinking, drops, and placement. Sand-blasted carbon face gives better spin than expected for a control paddle. Thermoformed unibody build at a budget price.",
  },
  {
    id: 9,
    name: "CRBN 1X Power Series 16mm",
    brand: "CRBN",
    price: 200,
    image: "https://m.media-amazon.com/images/I/61CYOGKTrwL._AC_SL1500_.jpg",
    affiliateLink: "https://amzn.to/4csLgUP",
    weight: "8.0 oz",
    core: "Polymer Honeycomb",
    ...
    control: 7,
    spin: 10,
    tags: ["power", "spin", "intermediate", "advanced", "heavy", "high-spin", "mid"],
    description: "The spin king. Raw carbon fiber generates more RPM than almost anything. Perfect for weaponizing third shot drops and heavy topspin drives.",
  },
  {
    id: 10,
    name: "JOOLA Ben Johns Hyperion CAS 16mm",
    brand: "JOOLA",
    price: 200,
    image: "https://m.media-amazon.com/images/I/7134U9PRJQL._AC_SL1500_.jpg",
    affiliateLink: "https://amzn.to/48oCXb2",
    weight: "8.0 oz",
    ...
    spin: 9,
    tags: ["power", "spin", "intermediate", "advanced", "heavy", "high-spin", "mid"],
    description: "Built for aggressive players. Carbon surface generates insane spin while elongated shape adds reach and power on every drive.",
  },
  {
    id: 11,
    ...
    brand: "Selkirk",
    price: 109,
    image: "https://m.media-amazon.com/images/I/71xB0vSO47L._AC_SL1500_.jpg",
    affiliateLink: "https://amzn.to/4twwm6N",
    weight: "7.6 oz",
    core: "Polymer Rev-Core",
    ...
    control: 9,
    spin: 8,
    tags: ["control", "beginner", "intermediate", "medium", "mid-spin", "mid"],
    description: "Incredible value from a top brand. Wide body and lighter weight are forgiving. Carbon surface delivers solid spin. Great stepping stone.",
  },
  {
    id: 12,
    ...
    brand: "HEAD",
    price: 159,
    image: "https://m.media-amazon.com/images/I/71O5yqbfSvL._AC_SL1500_.jpg",
    affiliateLink: "https://amzn.to/47EBlty",
    weight: "7.9 oz",
    core: "Polymer",
    ...
    description: "Balanced across power, control, and spin with zero weak spots. Adapts to whatever the game demands — singles or doubles.",
  },
  {
    id: 13,
    name: "JOOLA Solaire CFS 14mm",
    brand: "JOOLA",
    price: 179,
    image: "https://m.media-amazon.com/images/I/41HlqRBczoL._AC_SL1200_.jpg",
    affiliateLink: "https://amzn.to/3PYyXrt",
    weight: "7.7 oz",
    core: "Reactive Polymer",
    ...
    control: 8,
    spin: 9,
    tags: ["all-around", "spin", "intermediate", "medium", "high-spin", "mid"],
    description: "Leans into spin without sacrificing control. 14mm core gives larger sweet spot and softer feel at the net. Great for developing spin game.",
  },
  {
    id: 14,
    ...
    brand: "Engage",
    price: 189,
    image: "https://m.media-amazon.com/images/I/41woHGwuD5L._AC_SL1001_.jpg",
    affiliateLink: "https://amzn.to/47ErNyG",
    weight: "7.8 oz",
    ...
    control: 9,
    spin: 8,
    tags: ["control", "intermediate", "advanced", "medium", "mid-spin", "mid"],
    description: "Win by outthinking opponents. Exceptional touch at the kitchen. Gritty surface puts the ball exactly where you want it.",
  },
  {
    id: 15,
    ...
    brand: "Paddletek",
    price: 145,
    image: "https://m.media-amazon.com/images/I/61uvug1eh7L._AC_SL1500_.jpg",
    affiliateLink: "https://amzn.to/4meM0kS",
    weight: "7.6 oz",
    core: "Polymer Smart Response",
    surface: "Textured Composite",
    power: 6,
    control: 10,
    spin: 7,
    tags: ["control", "intermediate", "medium", "mid-spin", "mid"],
    description: "If your game is about patience, soft hands, and winning the kitchen battle, this was made for you. Best for doubles soft game.",
  },
  {
    id: 16,
    name: "Vatic Pro V-Sol Pro",
    brand: "Vatic Pro",
    price: 100,
    image: "https://m.media-amazon.com/images/I/51yF-cFfE+L._AC_SL1500_.jpg",
    affiliateLink: "https://amzn.to/3O2l2Qw",
    weight: "7.6-7.9 oz",
    core: "Polymer + Foam",
    surface: "T700 Carbon Fiber",
    power: 8,
    control: 7,
    spin: 8,
    tags: ["power", "intermediate", "medium", "mid-spin", "mid"],
    description: "Best budget power paddle of 2026. Three shape options. Real offensive upside without spending premium money. Game-ready out of the wrapper.",
  },
  {
    id: 17,
    name: "Franklin C45 Dynasty 16mm",
    brand: "Franklin",
    price: 180,
    image: "https://m.media-amazon.com/images/I/81hTK9VAsOL._AC_SL1500_.jpg",
    affiliateLink: "https://amzn.to/4s9dxFp",
    weight: "7.6-7.9 oz",
    core: "Thermoformed Unibody",
    surface: "Carbon Hybrid",
    power: 8,
    control: 7,
    spin: 8,
    tags: ["power", "all-around", "intermediate", "advanced", "medium", "mid-spin", "mid"],
    description: "Used by multiple pro players. Double thermoformed unibody gives great mix of control and power. Lighter and quicker through the air.",
  },
  {
    id: 18,
    name: "CRBN 2X Power Series 16mm",
    brand: "CRBN",
    price: 200,
    image: "https://m.media-amazon.com/images/I/61xpea4YxvL._AC_SL1500_.jpg",
    affiliateLink: "https://amzn.to/41cgpXe",
    weight: "8.3 oz",
    core: "Polymer Honeycomb",
    surface: "Toray Carbon Fiber",
    power: 10,
    control: 6,
    spin: 10,
    tags: ["power", "spin", "advanced", "heavy", "high-spin", "mid"],
    description: "Maximum power + maximum spin in a wide-body frame. Built for singles players who want to overpower from every position on court.",
  },
  {
    id: 19,
    ...
    brand: "JOOLA",
    price: 250,
    image: "https://m.media-amazon.com/images/I/51u4AYfKqsL._AC_SL1500_.jpg",
    affiliateLink: "https://amzn.to/4sbJyN6",
    weight: "8.1 oz",
    core: "Propulsion Core + Tech Flex Foam",
    surface: "Textured Carbon Fiber",
    power: 10,
    control: 7,
    spin: 9,
    tags: ["power", "all-around", "advanced", "heavy", "high-spin", "premium"],
    description: "Explosive power that feels like a rocket. Insane spin on serves. Foam outside the frame expands sweet spot. Best for aggressive advanced players.",
  },
  {
    id: 20,
    name: "CRBN TruFoam Genesis 3",
    brand: "CRBN",
    price: 230,
    image: "https://m.media-amazon.com/images/I/71habxzR5uL._AC_SL1500_.jpg",
    affiliateLink: "https://amzn.to/4vehNXa",
    weight: "8.0-8.1 oz",
    core: "100% Foam Core",
    surface: "Toray Carbon Fiber",
    power: 7,
    control: 9,
    spin: 10,
    tags: ["control", "spin", "advanced", "heavy", "high-spin", "premium"],
    description: "First 100% foam core paddle delivers top-tier dwell time and spin. Ball goes exactly where you want it. Plush stable feel for selective attackers.",
  },
  {
    id: 21,
    name: "Selkirk LUXX Control Air Invikta",
    brand: "Selkirk",
    price: 250,
    image: "https://m.media-amazon.com/images/I/51NMLgy+mTL._AC_SL1080_.jpg",
    affiliateLink: "https://amzn.to/41eYC1D",
    weight: "7.8-8.1 oz",
    core: "Polymer",
    surface: "InfiniGrit Carbon Fiber",
    power: 7,
    control: 10,
    spin: 9,
    tags: ["control", "spin", "advanced", "medium", "high-spin", "premium"],
    description: "Precision and reach combined. InfiniGrit surface keeps control steady across long matches. Great balance of forgiveness and stability.",
  },
  {
    id: 22,
    ...
    brand: "Selkirk",
    price: 129,
    image: "https://m.media-amazon.com/images/I/41cuKVb1eDL._AC_SL1010_.jpg",
    affiliateLink: "https://amzn.to/48tCSmu",
    weight: "8.2 oz",
    ...
    control: 6,
    spin: 8,
    tags: ["power", "intermediate", "advanced", "heavy", "mid-spin", "mid"],
    description: "The power player\'s dream. Air Dynamic Throat reduces drag. Heavy weight transfers maximum energy into every shot. Not for the faint of heart.",
  },
  {
    id: 23,
    name: "JOOLA Scorpeus CFS 16mm",
    brand: "JOOLA",
    price: 230,
    image: "https://m.media-amazon.com/images/I/61d-cVLl4bL._AC_SL1500_.jpg",
    affiliateLink: "https://amzn.to/48sYm2S",
    weight: "8.0 oz",
    core: "Reactive Polymer",
    surface: "Carbon Friction Surface",
    power: 7,
    ...
    spin: 9,
    tags: ["control", "spin", "advanced", "heavy", "high-spin", "premium"],
    description: "Designed with Collin Johns. Poppy for a control paddle but 16mm core and wide body keep it control-focused. Power when needed, control when it counts.",
  },
];
...
function PaddleCard({ paddle, rank }) {
  return (
    ...
    >
      {/* Product Image */}
      {paddle.image && paddle.image.startsWith("http") && (
